...
class TTSProvider(TTSProviderBase):
    ...
    async def start_session(self, session_id):
        ...
        try:
            ...
            run_task_message = {
                ...
                "payload": {
                    ...
                    "parameters": {
                        ...
                        **({"language_hints": [self.language_hints]} if self.language_hints else {}),
            ...
            logger.bind(tag=TAG).info(f"TTS请求参数: {json.dumps(run_task_message['payload']['parameters'], ensure_ascii=False)}")
